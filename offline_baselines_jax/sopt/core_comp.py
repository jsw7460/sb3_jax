...
def sensor_based_action_matcher_update(
    ...
    def action_matcher_loss_fn(params: Params) -> Tuple[jnp.ndarray, InfoDict]:
        pred_actions = action_matcher.apply_fn(     # Predicted high (real) action
            {"params": params},
            observations,
            low_actions,
            deterministic=False,

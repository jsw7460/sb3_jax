...
class SACBC(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            bc_coef = 1.0 if self.num_timesteps < 100000 else 0.0
            sac_coef = 0.0 if self.num_timesteps < 100000 else 1.0
        ...
        if self.num_timesteps % 500 == 0:
            ...
            self.logger.record("config/sac_coef", sac_coef, exclude="tensorboard")

...
def sac_critic_update(key:Any, actor: Model, critic: Model, critic_target: Model, log_ent_coef: Model,
    ...
    def critic_loss_fn(critic_params: Params) -> Tuple[jnp.ndarray, InfoDict]:
        ...
        conservative_loss_1 = jax.scipy.special.logsumexp(jnp.ndarray([cql_q1 - cql_log_prob, random_q1 - random_density])).mean() - current_q1.mean()
        conservative_loss_2 = jax.scipy.special.logsumexp(jnp.ndarray([cql_q2 - cql_log_prob, random_q2 - random_density])).mean() - current_q2.mean()
